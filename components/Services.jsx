...
const CORE_SERVICES = [
  {
    ...
    desc: 'Thermal engineering of multi-stage evaporators tailored to the rheological behavior and boiling point elevation (BPE) profiles of industrial liquids. We construct advanced mass and energy balances that balance multi-effect configurations to extract maximum thermal work from primary steam. By integrating high-efficiency Thermal Vapor Recompressors (TVR) or Mechanical Vapor Recompressors (MVR), our layouts capture and recompress low-pressure boiling vapors, recycling the latent heat back into the calandria shell. This approach optimizes the overall heat transfer coefficient, drastically driving down Specific Steam Consumption (SSC) while keeping product exposure temperatures within safe limits.'
  },
  {
    icon: ShieldAlert,
  ...
  },
  {
    ...
    highlights: [
      ...
      'Minimum fluidization velocity (Umf) hydrodynamic sizing',
      'Continuous vibrating & multi-zone temperature processing',
    ],
    desc: 'Thermal design of fluid bed dryers engineered to achieve highly uniform moisture reduction across crystalline solids, granular materials, and heat-sensitive particulate matrices. We calculate precise fluidization dynamics to establish steady hydrodynamic boundaries, ensuring gas velocities remain consistently above the minimum fluidization threshold without triggering unwanted material entrainment or terminal channel bypassing. Our structural configurations feature multi-zone temperature grids, allowing for distinct heating, soaking, and ambient cooling cycles within a single continuous system, while custom-perforated gas distribution plates ensure uniform air distribution to eliminate localized hot spots and material scorching.'
  },
  {
    icon: Layers,
