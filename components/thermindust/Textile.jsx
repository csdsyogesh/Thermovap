          ...
          <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
            ...
            <section className="grid gap-8 lg:grid-cols-2">
              <div className="bg-card border border-border rounded-2xl p-8 space-y-4">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed text-justify">
                  Achieving a complete zero liquid discharge (ZLD) boundary requires balancing heavy mass loops. Our thermal configurations isolate mixed-salt solids via continuous centrifuge loops while recovering up to 95 percent of process water volume, protecting operations from water scarcity and local environmental restrictions.
                </p>
              </div>
              <div className="bg-card border border-border rounded-2xl p-8 space-y-4">
                <h3 className="text-xl font-bold text-card-foreground flex items-center gap-2">
            ...
            <section className="space-y-6">
              ...
              <div className="grid gap-4">
                {[
                  { q: "What water quality metrics does the recovered condensate meet?", a: "The recovered water exhibits an electrical conductivity under 30 micro-Siemens/cm and minimal TDS, allowing immediate reuse inside sensitive textile dyeing operations." },
                  { q: "How do your designs prevent tube clogging from sodium sulfate salts?", a: "We utilize specific forced circulation velocities (greater than 2.0 m/s) paired with static head pressure to prevent boiling inside the heat exchanger, shifting precipitation safely to the flash drum." },
                  { q: "What is the baseline water recovery efficiency of your textile ZLD systems?", a: "Our setups regularly recover between 92 percent and 96 percent of the incoming effluent volume as clean distillate, leaving only a highly dense slurry for salt separation." },
                  ...
                  { q: "Does the system support variations in dye house effluent volume?", a: "Yes. We incorporate automated turndown controls and flexible liquid balancing loops to manage volumetric swings up to 30 percent smoothly." },
                  ...
                  { q: "How does the system manage severe foaming caused by synthetic detergents and textile surfactants during evaporation?", a: "We integrate specialized vapor-liquid separation geometries with oversized flash chambers to lower internal vapor velocities. This structural design, paired with automated anti-foam chemical dosing loops, effectively collapses foam matrices before they can carry over into the clean condensate lines." }
                ].map((faq, idx) => (
