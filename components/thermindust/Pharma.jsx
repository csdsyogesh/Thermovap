...
import { ArrowLeft, HelpCircle, CheckCircle2, Cpu, Pill, BarChart3, ShieldAlert } from 'lucide-react';
          ...
          <section className="space-y-6">
            ...
            <div className="grid gap-4">
              {[
                ...
                { q: "What is the typical surface finish achieved for pharmaceutical product paths?", a: "All internal surfaces undergo precise mechanical polishing followed by electro-polishing to achieve a surface roughness rating under $0.4-0.5\ \mu\text{m}$." },
                { q: "Can your systems recover volatile organic solvents from API manufacturing rejects?", a: "Yes. Our high-vacuum solvent fractionating columns split and reclaim up to 97% of volatile compounds like acetone or toluene for direct facility reuse." },
                ...
                { q: "How do you manage the recovery of high-purity water?", a: "Our vapor separators combine spacious velocity drops with multi-stage demister pads to isolate clean water condensates with conductivity levels under $1.5\ \mu\text{s/cm}$." },
