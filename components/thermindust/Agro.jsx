            ...
            <section className="space-y-6">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  { q: "What solid concentration baseline is reached before the drying phase?", a: "Our multi-effect pre-concentrators safely increase standard distillery slops from 8 percent starting solids up to a dense 55 to 60 percent total solids syrup." },
                  ...
                  { q: "Does the system support variations in distillery plant throughput volumes?", a: "Yes. We integrate automated turndown controls and flexible recirculation configurations to handle variations in volumetric feed rates up to 25 percent smoothly." },
                  ...
                  { q: "What control method prevents product burning inside finishing stages?", a: "We restrict local heat flux rates by operating the final effects under lower steam temperatures while scaling up the internal fluid movement to maintain high boundary turbulence." }
                ].map((faq, idx) => (
