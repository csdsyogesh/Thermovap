...
export default function ChemicalProcess() {
  return (
    <>
      <SEO 
        title="Chemical & Process Industry Evaporators" 
        description="Heavy-duty concentration systems built with corrosion-resistant alloys (MOC) to handle volatile chemical streams and aggressive inorganic acids."
        url="/thermindust/chemical-process"
      />
            ...
            <section className="grid gap-8 lg:grid-cols-2">
              <div className="bg-card border border-border rounded-2xl p-8 space-y-4">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed text-justify">
                  Chemical processing layouts leverage advanced thermal cascading strategies to drive steam economies to their thermodynamic limits. We integrate Mechanical Vapor Recompression (MVR) blowers or multi-stage TVR units that compress volatile product vapors, recycling the latent heat energy directly back into the primary stage calandria to dramatically cut plant utility overheads.
                </p>
              </div>
              <div className="bg-card border border-border rounded-2xl p-8 space-y-4">
                <h3 className="text-xl font-bold text-card-foreground flex items-center gap-2">
            ...
            <section className="space-y-6">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  { q: "What is the primary method used to prevent salt scaling inside the tubes?", a: "We maintain high internal tube velocities (greater than 2.2 m/s) paired with precise hydrostatic heads. This approach suppresses localized boiling inside the tube bundle, forcing crystal precipitation to occur inside the flash vessel." },
                  ...
                  { q: "How do you calculate the optimal baffle spacing for shell-and-tube exchangers?", a: "We utilize rigorous fluid dynamics calculations to establish high convective heat transfer coefficients (U) while keeping shell-side pressure drops low." },
                  { q: "What solid contents can be reached when processing chemical brine rejects?", a: "Our heavy-duty forced circulation crystallizers can continually concentrate raw brine solutions up to a thick 50 to 60 percent slurry phase, ideal for direct centrifugal separation." },
                  ...
                  { q: "What typical maintenance intervals do your configurations support?", a: "Due to high-velocity scrambling and ion-balanced design configurations, our chemical units routinely sustain continuous operating windows of 3 to 5 weeks between cleaning sweeps." },
                  ...
                  { q: "What criteria regulate structural layout parameters for handling highly volatile compounds?", a: "We utilize deep-vacuum condensation networks paired with secondary gas recovery loops to condense low-boiling volatile vapors cleanly, matching strict industrial safety emission limits." }
                ].map((faq, idx) => (
