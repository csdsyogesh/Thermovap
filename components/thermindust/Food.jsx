            ...
            <div className="grid gap-4">
              {[
                { 
                  ...
                  a: "By operating under low absolute pressures, we drop the boiling point below critical thresholds (typically $50^\circ\text{C}$ to $55^\circ\text{C}$). This configuration, paired with continuous falling film distribution, eliminates localized hotspots and ensures milk proteins, vitamins, and flavor properties undergo zero thermal degradation or Maillard browning." 
                },
                { 
                ...
                { 
                  ...
                  a: "All product contact zones are manufactured with premium, electro-polished stainless steel (MOC matching SS316L with a surface roughness $R_a < 0.8\ \mu\text{m}$). The layout features self-draining geometric paths with no dead-legs, explicitly tuned to interface seamlessly with multi-stage automated CIP loops for daily sterilization." 
                },
                { 
                ...
                },
                {
                  ...
                  a: "Our food and dairy systems are built for multi-step automated Clean-In-Place cycles, supporting sequential caustic washes ($1.5-2.0\%$ $\text{NaOH}$ at $75-80^\circ\text{C}$), acid rinses ($0.5-1.0\%$ $\text{HNO}_3$), and high-purity water flushes, minimizing downtime to keep operations continuous."
                },
                {
