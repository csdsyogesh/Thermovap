          ...
          <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
            <section className="bg-card border border-border rounded-2xl p-8 lg:p-12 space-y-6">
              ...
              <div className="space-y-4 text-muted-foreground text-sm leading-relaxed text-justify">
                <p>
                  Concentrating black liquor requires addressing its non-Newtonian, highly viscous behavior as total solids push past 65 percent. Our engineers handle these demanding rheological properties by structuring multi-stage setups that combine rising-film and forced circulation evaporation loops. By distributing the liquid through custom internal channels and adjusting thermal exposures sequentially, we maintain high convective heat transfer parameters over extended runs.
                </p>
                <p>
            ...
            <section className="space-y-6">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  { q: "What total solid concentration baseline can your systems achieve?", a: "Our multiple-effect evaporation configurations can continuously step up standard black liquor from 15 percent solids up to over 70 to 75 percent total solids concentration." },
                  { q: "How do you counteract rapid silica scaling on the inner tube walls?", a: "We maintain turbulent flow regimes (greater than 2.2 m/s) combined with automated washing loops to sweep away silica elements before they bind to heat-transfer surfaces." },
                  ...
                  { q: "Can your systems handle sudden variations in incoming feed concentration?", a: "Yes. We incorporate automated level controls and liquor recirculation loops to absorb volumetric and concentration adjustments up to 25 percent safely." },
                  ...
                  { q: "How does the system handle non-condensable gas (NCG) venting?", a: "We incorporate specific NCG extraction points across the calandria shells to continuously purge non-condensable gases, ensuring high heat-transfer efficiency." },
                  ...
                  { q: "What process feature addresses the dramatic increase in boiling point elevation at high solid concentrations?", a: "We split the final processing phase into specialized product-concentrator arrays that run under increased thermal driving forces, balancing the natural boiling penalties to achieve uniform solids delivery." }
                ].map((faq, idx) => (
