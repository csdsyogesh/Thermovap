          ...
          <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
            <section className="bg-card border border-border rounded-2xl p-8 lg:p-12 space-y-6">
              ...
              <div className="space-y-4 text-muted-foreground text-sm leading-relaxed text-justify">
                <p>
                  Botanical matrix concentration demands strict operational boundaries due to the rapid degradation kinetics of active phytochemicals under sustained thermal stress. We engineer custom multi-stage falling film or rising film configurations running under high vacuum levels to suppress boiling points well below 50 degrees Celsius. By utilizing specific internal distribution mechanisms and short-path geometric clearances, we force absolute minimum residence times, preventing degradation of complex tannic chains, alkaloids, and volatile polyphenols.
                </p>
                <p>
            ...
            <section className="space-y-6">
              ...
              <div className="grid gap-4">
                {[
                  { q: "How do your thermal systems protect temperature-sensitive botanical extracts?", a: "We operate our evaporator networks under deep vacuum profiles, which significantly reduces the internal boiling point to 45 degrees Celsius to 50 degrees Celsius. This approach, combined with single-pass short residence times, ensures delicate bio-molecules experience zero thermal breakdown." },
                  ...
                  { q: "What efficiency metrics can be expected for volatile solvent recovery?", a: "Our completely sealed vacuum vapor condensing loops isolate and reclaim up to 98 percent of volatile processing solvents like ethanol, minimizing raw material losses." },
                  ...
                  { q: "What is the typical solid content baseline achieved before final drying stages?", a: "Our multi-effect pre-concentrators safely step up typical extract streams from a low 5 to 10 percent starting baseline up to 45 to 55 percent total solids prior to finishing operations." },
                  ...
                  { q: "What structural configurations manage high boiling point elevations in concentrated catechu solutions?", a: "As the tannin and complex polymer content scales upward, we introduce forced-recirculation loops that maintain uniform flow patterns, counteracting the natural boiling penalties and driving continuous mass transfer across the tube faces." }
                ].map((faq, idx) => (
