        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
          <section className="bg-card border border-border rounded-2xl p-8 lg:p-12 space-y-6">
            ...
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed text-justify">
              <p>
                Managing heavy reverse osmosis (RO) brine rejects and complex Effluent Treatment Plant (ETP) wastewater requires robust thermal processing infrastructure to close the recycling loop completely. We engineer highly efficient brine concentrators and forced circulation crystallization modules that continuously reduce waste volumes by upwards of $95\%$. Our design approaches map specific scale boundaries to maximize clean water yield while maintaining process stability.
              </p>
              <p>
          ...
          <section className="space-y-6">
            ...
            <div className="grid gap-4">
              {[
                { q: "What water purity standards does the recovered distillate meet?", a: "The recovered distillate routinely shows electrical conductivity under $20-50\ \mu\text{S/cm}$, making it fully compatible with raw cooling tower or boiler feed loops." },
                ...
                { q: "What is the primary energy saving mechanism in your ZLD layouts?", a: "We integrate high-efficiency MVR mechanical blowers that recompress exhaust vapors, reducing live steam demands by up to 70% during continuous operations." },
                { q: "How do your designs prevent calcium sulfate scaling inside the heat exchanger?", a: "By maintaining tube velocities over $2.2\text{ m/s}$ and keeping hydrostatic heads adjusted, we suppress internal boiling and prevent scale formation inside the tubes." },
                ...
                { q: "Can the system adapt to changes in wastewater feed volume?", a: "Yes. Our systems feature automated flow tracking and adjustable recirculation controls to manage volumetric variations up to 30% smoothly." },
