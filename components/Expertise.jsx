...
import { Link } from 'react-router-dom' // 🌟 Imported for clean routing
...
const FEATURES = [
  {
    icon: Sparkles,
    href: "/expertise/design-optimization", // 🔗 Route to custom design subpage
    title: 'Design & Optimization',
    desc: 'Custom design and performance optimization for maximum efficiency.',
  },
  {
    icon: ClipboardCheck,
    href: "/expertise/technical-audits", // 🔗 Route to audits subpage
    title: 'Technical Audits',
    desc: 'On-site & remote audits for energy flow and utility optimization.',
  },
  {
    icon: Calculator,
    href: "/expertise/process-calculations", // 🔗 Route to calculations subpage
    title: 'Process Calculations',
    desc: 'Thermal design, heat balance, and equipment sizing support.',
  },
  {
    icon: Wrench,
    href: "/expertise/troubleshooting", // 🔗 Route to troubleshooting subpage
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {FEATURES.map((f, i) => (
                <Reveal key={f.title} delay={i}>
                  {/* 🌟 Wrapped in a Framer Motion-enhanced Link to keep active hover springs */}
                  <motion.div
                    whileHover={{ y: -4 }}
