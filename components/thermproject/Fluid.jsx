            ...
            <section className="space-y-6">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  { q: "What specific parameter regulates air distribution pressure drop across the bed floor?", a: "We calibrate the structural orifice parameters on the perforated distributor plate to maintain a resistance profile equal to roughly 20 percent of the aggregate fluidized bed weight." }
                ].map((faq, idx) => (
