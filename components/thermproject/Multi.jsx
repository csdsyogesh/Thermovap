            ...
            <section className="space-y-6">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  { q: "What structural measures regulate the powder cross-flow between the spray cone and the bed deck?", a: "We construct precise internal layout geometries where the angle of the lower discharge cone matches or exceeds the product friction constraints, guaranteeing smooth powder transit onto the secondary fluidizing plate." }
                ].map((faq, idx) => (
