            ...
            <section className="space-y-6">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  { q: "What structural design standard is applied to handle possible chamber overpressure scenarios?", a: "We size every industrial tower structure with heavy-duty explosion relief panels or dynamic suppression systems matching regional industrial safety constraints to relieve instantaneous dust expansion vectors safely." }
                ].map((faq, idx) => (
