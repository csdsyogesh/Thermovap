          ...
          <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
            <section className="bg-card border border-border rounded-2xl p-8 lg:p-12 space-y-6">
              ...
              <div className="space-y-4 text-muted-foreground text-sm leading-relaxed text-justify">
                ...
                <p>
                  By maintaining a high hydrostatic head and backpressure over the top tube sheet, the system suppresses boiling entirely within the heat exchanger. The fluid remains in a liquid phase throughout its transit across the calandria, absorbing sensible heat. Boiling is only permitted when the superheated liquid enters the lower pressure zone of the flash separation vessel. The solvent flashes off instantly, forcing solid crystallization or rapid concentration safely away from the primary heat transfer surfaces.
                </p>
              </div>
            </section>
            ...
            <section className="space-y-6">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  ...
                  "Optimized Low Maintenance Calandria Profiles"
                ].map((tech, idx) => (
            ...
            <section className="space-y-6">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  { q: "What design feature controls the expansion of the crystalline slurry inside the separator cone?", a: "We configure the separator with an oversized, low-velocity lower section to promote uniform crystal growth, keeping small crystals suspended for classification while dense chunks drop out safely." }
                ].map((faq, idx) => (
