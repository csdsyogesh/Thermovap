          ...
          <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
            <section className="bg-card border border-border rounded-2xl p-8 lg:p-12 space-y-6">
              ...
              <div className="space-y-4 text-muted-foreground text-sm leading-relaxed text-justify">
                <p>
                  Rising Film (or Climbing Film) Evaporators utilize a natural thermo-siphon principle to lift and concentrate solutions inside vertical shell-and-tube configurations. The liquid feed enters from the bottom header of the calandria and fills the lower segments of the tube bundle. As steam passes through the outer shell side, heat transfer triggers rapid localized boiling at the base of the inner tubes, producing expanding vapor bubbles.
                </p>
                <p>
            ...
            <section className="space-y-6">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  { q: "What control parameters establish the baseline liquid level inside the lower header during operation?", a: "We integrate precision differential pressure sensors at the bottom layout to manage absolute fluid thresholds, preventing tube-dryout or overflowing conditions." }
                ].map((faq, idx) => (
