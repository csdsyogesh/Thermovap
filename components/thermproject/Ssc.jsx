          ...
          <section className="space-y-6">
            ...
            <div className="grid gap-4">
              {[
                ...
                { q: "How does the single-pass design protect product quality?", a: "The combination of thin-film mechanics and rapid rotor transport limits total thermal residence time to mere seconds, preserving natural colors and active ingredients." },
