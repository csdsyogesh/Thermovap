            ...
            <section className="space-y-6">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  { q: "What parameter prevents localized product baking against the bottom fluidizing wall?", a: "We size a protective cold-air cooling jacket layer around the hot air distribution ring manifold layout, keeping structural temperatures below critical material sticking boundaries." }
                ].map((faq, idx) => (
