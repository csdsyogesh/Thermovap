            ...
            <section className="space-y-6">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  { q: "What criteria establish the maximum permissible trough loading percentage?", a: "We limit the cross-sectional trough load (typically to 15% or 30% capacity boundaries) based on the material's abrasive index and stickiness, reducing internal friction heat and preventing bearing wear." }
                ].map((faq, idx) => (
