          ...
          <section className="relative py-24 border-b border-border overflow-hidden">
            <div className="relative max-w-5xl mx-auto px-4 text-center">
              ...
              <p className="mt-4 text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                Heavy-duty indirect contact thermal drying systems engineered to process high-volume sludges, crystalline cakes, and dense chemical residues.
              </p>
            </div>
          </section>
            ...
            <section className="space-y-6">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  { q: "How is the thermal heat transfer coefficient (U) kept high across varying product dampness zones?", a: "The wedge-shaped profiles create continuous local mechanical pressure as they turn. This actions keeps fresh material constantly sliding along the hot faces to prevent heat transfer stagnation." }
                ].map((faq, idx) => (
