          ...
          <section className="space-y-6">
            ...
            <div className="grid gap-4">
              {[
                ...
                { q: "How does the system counteract severe mineral scale buildup?", a: "We deploy high-velocity forced circulation loops ($>2.2$ m/s) in the crystallization stages to suppress localized internal boiling and minimize scale formation on tube walls." },
