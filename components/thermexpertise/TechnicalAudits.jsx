...
import { ArrowLeft, HelpCircle, ClipboardCheck } from 'lucide-react';
            ...
            <section className="space-y-6">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  { q: "What diagnostics map local vacuum decay profiles across long vapor duct tracks?", a: "We apply portable ultrasonic micro-leak detectors paired with sequential pressure isolation testing to track minor air entrainments that compromise vacuum stability and lower thermal driving forces." },
                  { q: "How do you evaluate whether a mechanical vapor recompression blower is operating off its design curve?", a: "We compare real-time motor electrical current draw and static discharge pressure steps against the manufacturer baseline profiles, identifying internal blade erosion or impeller fouling." },
                  { q: "What specific fluid parameter indicates non-condensable gas accumulation within the calandria shell side?", a: "A localized dropping of the heat transfer rate paired with stagnant temperature pockets at the upper shell boundaries indicates air blanket accumulation, signaling a need to re-engineer or clear the venting nozzle pathways." }
                ].map((faq, idx) => (
