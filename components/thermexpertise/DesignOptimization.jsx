      ...
      <div>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
          ...
          <section className="bg-card border border-border rounded-2xl p-8 lg:p-12 space-y-6">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              We look beyond individual components to optimize the entire thermal plant lifecycle. Our team models vapor recompression paths, plans multi-stage staging balances, and introduces advanced structural geometry parameters—such as optimized $60^\circ$ triangular tube sheets—to turn complex industrial heat liabilities into reliable, high-yield, and low-consumption assets.
            </p>
          </section>

          <section className="space-y-6">
            <h2 className="text-2xl font-bold text-card-foreground tracking-tight border-l-4 border-primary pl-3">Design & Optimization FAQ Matrix</h2>
