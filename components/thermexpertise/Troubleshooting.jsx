...
import { SEO } from '../SEO'; 
import { ArrowLeft, HelpCircle, Wrench } from 'lucide-react';
          ...
          <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
            ...
            <section className="space-y-6">
              <h2 className="text-2xl font-bold text-card-foreground tracking-tight border-l-4 border-primary pl-3">
                Operational Troubleshooting FAQ Matrix
              </h2>
              <div className="grid gap-4">
                {[
                  ...
                  { q: "What diagnostic workflow isolates rapid vacuum loss within a multi-effect configuration?", a: "We execute systematic drop-tests across individual effect blocks under isolation, matching vacuum recovery tracking arrays to differentiate between condenser cooling water restrictions and localized ambient air ingress leaks." },
                  { q: "Why do multi-effect systems experience a sudden drop in steam economy during stationary load steps?", a: "A drop in steam economy ratios points toward faulty condensate steam traps passing raw live vapor or a breakdown inside the TVR ejector nozzle tolerances, causing high primary steam bypass loops." },
                  { q: "What parameter balances localized crystal scaling along fallback heat exchanger decks?", a: "We closely trace the log mean temperature difference boundaries relative to liquid saturation curves. If the delta-T limits scale past critical thresholds, localized boundary baking forces hard mineral crystallization directly onto the metal walls." }
                ].map((faq, idx) => (
