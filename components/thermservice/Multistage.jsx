          ...
          <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
            ...
            <section className="bg-card border border-border rounded-2xl p-8 lg:p-12 space-y-4">
              ...
              <div className="my-4 p-4 bg-muted/30 rounded-lg text-center font-mono text-sm border border-border text-primary">
                SHC_total = [Q_stage1 + Q_stage2 - Q_recovered] / m_water_evaporated
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
            ...
            <section className="space-y-6">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  { q: "How does air cascading improve the specific heat consumption (SHC) index?", a: "Instead of discharging hot, unsaturated exhaust straight to the stack, we route the low-grade thermal energy from the fluid bed back into the secondary air stream or preheating loops, capturing otherwise wasted enthalpy." },
                  { q: "What process conditions dictate using a vibrating fluid bed at the final stage?", a: "A vibrating fluid bed (VFBD) is chosen when dealing with hygroscopic, fragile, or sticky materials that tend to compact or clump under regular fluidization velocities, assisting in smooth powder advancement." },
                  { q: "How do you control absolute moisture content across changing ambient humidity environments?", a: "We equip our main air intake skids with automatic dehumidification or steam coil air-heating loops that modulate inlet temperatures based on real-time feedback from exhaust relative humidity sensors." },
                  { q: "What mechanisms prevent fine powder loss within multi-stage air recirculation loops?", a: "We combine high-velocity cyclonic separation with pulse-jet cloth bag filters. Collected fine particulates are continuously separated and fed back into the drying matrix via rotary airlock valves." },
                  { q: "Can multi-stage setups process highly corrosive chemical streams?", a: "Yes. Every wet-wall zone, fluidizing deck, and exhaust manifold is custom engineered using high-performance metallurgies such as Duplex Stainless Steel, Titanium alloys, or high-nickel coatings based on your fluid profile." },
                  { q: "How is the transit time of the product monitored across separate drying tiers?", a: "Primary stage transit occurs in milliseconds via flash atomization. Secondary and tertiary bed retention times are controlled by adjusting variable-speed mechanical discharge gates and adjusting structural weir heights." }
                ].map((faq, idx) => (
