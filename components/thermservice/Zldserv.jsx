          ...
          <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
            ...
            <section className="space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="bg-card p-6 rounded-2xl border border-border space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Recover low-conductivity condensate water, returning high-purity distillate back into plant cooling towers and boilers to reduce overall raw water intake needs.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="bg-card border border-border rounded-2xl p-8 lg:p-12 space-y-4">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Uncontrolled scaling from calcium, silicates, or sulfates onto tube inner walls is the leading cause of downtime in standard ZLD plants. Thermovap eliminates this risk by maintaining strict fluid velocities greater than 2.2 m/s combined with high hydrostatic heads. This layout configuration ensures boiling and salt precipitation occur inside the separator flash tank rather than inside the heat exchanger tubes.
              </p>
            </section>
            ...
            <section className="space-y-6">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  { q: "How does Thermovap handle high boiling point elevation (BPE) in brine mixes?", a: "Concentrated wastewater often displays massive BPE spikes (10°C to 18°C). We design our multi-stage vacuum settings to maintain a healthy temperature driving force (ΔT)." },
