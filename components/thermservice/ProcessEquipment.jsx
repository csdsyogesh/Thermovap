          ...
          <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
            ...
            <section className="space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="bg-card p-6 rounded-2xl border border-border space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Complete documentation detailing Log Mean Temperature Difference (ΔT_lm), fouling resistances, tube layouts matching specified pass numbers, and shell thickness allowances.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="bg-card border border-border rounded-2xl p-8 lg:p-12 space-y-4">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Poorly planned shell interiors create low-velocity dead zones that accelerate sediment drops and fouling. Conversely, excessive cross-flow velocities risk inducing fluid-elastic tube vibrations, leading to structural failures. Thermovap calculates precise baffle cuts and tube pitches (31.75 mm OD × 1.2 mm thickness elements) to achieve uniform flow patterns and extend equipment life.
              </p>
            </section>
            ...
            <section className="space-y-6">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  { q: "Why is a 1.2 mm thickness standard for 31.75 mm OD evaporator tubes?", a: "This configuration provides an optimized wall thickness that balances required mechanical strength under full vacuum with low thermal resistance for high heat transfer rates." },
                  ...
                  { q: "How do you calculate the required heat transfer area for a shell-and-tube unit?", a: "We size the heat transfer area (A) using the total heat load (Q), the global heat transfer coefficient (U), and the calculated Log Mean Temperature Difference (ΔT_lm) through the formula: Q = U · A · ΔT_lm." },
                  ...
                  { q: "How do you establish fluid velocity rules inside tube-side passes?", a: "We target a balance: velocity must remain high enough to maintain turbulence and limit fouling layers, yet bounded to avoid wall erosion and extreme pumping pressure constraints." },
                  { q: "What primary metrics guide selection for the overall material of construction (MOC)?", a: "We size metallurgy based on chloride parts-per-million scales, operating temperatures, and pH limits. Options range from standard stainless steel bounds up to Duplex, Titanium, or specialized alloy matrices." },
                  { q: "What mechanical code validation is provided for vacuum vessel safety?", a: "All structural thicknesses, reinforcement pads, flanges, and dished ends are calculated according to industrial manufacturing standards to withstand structural compression under external vacuum profiles." }
                ].map((faq, idx) => (
