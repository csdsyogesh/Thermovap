          ...
          <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
            ...
            <section className="bg-card border border-border rounded-2xl p-8 lg:p-12 space-y-4">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Evaluating thin-film conductive processing involves establishing the precise thermal area (A) required to counter variable product film coefficients (hf) as the fluid moisture drops away:
              </p>
              <div className="my-4 p-4 bg-muted/30 rounded-lg text-center font-mono text-sm border border-border text-primary">
                Q = U · A · ΔT_lm &nbsp;where&nbsp; 1/U = 1/h_steam + x_wall/k_wall + 1/h_film
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
                Thermovap maintains high values for film by sizing high tip-speed rotors that continuously peel back and renew the product boundary layer, providing high heat transfer rates across short exposure times.
              </p>
            </section>
            ...
            <section className="space-y-6">
              ...
              <div className="grid gap-4">
                {[
                  { q: "What typical clearance dimension is maintained between the rotor blades and the heating jacket?", a: "We maintain a tight mechanical clearance of 1.0 mm to 2.0 mm depending on the shell diameter, ensuring the rotor blades intensely agitate the product film without contacting the metal wall." },
                  ...
                  { q: "What parameter influences the feed retention time within a vertical ATFD system?", a: "Retention time depends on rotor tip speed, fluid viscosity, jacket length, and blade configuration. Our engineering team profiles rotor alignments to customize this duration for complex process targets." },
                  { q: "How is uniform feed distribution achieved across the top section of the inner wall?", a: "We integrate dedicated distribution rings with the rotating assembly. This prevents fluid channeling down one portion of the shell by throwing the feed evenly across the heated circumference." },
                  { q: "What primary materials of construction are selected for ATFD units processing high-chloride waste?", a: "To prevent severe pitting and stress-corrosion cracking, we utilize highly robust alloys like Duplex Stainless Steel (SS2205), Super Duplex, Hastelloy, or custom-lined carbon steel." },
                  { q: "Can an ATFD operate as a continuous concentrator without dropping down to a solid powder?", a: "Yes. By tailoring heat inputs and extraction speeds, the system can function as a high-viscosity evaporator, pulling out thick liquid concentrates without entering the crystallization block." },
                  { q: "What design features protect the lower discharge zone from blocking up?", a: "We size oversized bottom outlet extrusion cones paired with heavy-duty scraper blades that continuously force out high-density powder arrays without letting product bridge over." },
                  { q: "How does Thermovap compute the dynamic torque constraints for the main rotor drive motor?", a: "We evaluate viscosity profiles across all phase boundaries—from dilute slurry to paste and dry cake. Sizing includes safety factors to prevent startup lock-ups in the high-shear paste region." }
                ].map((faq, idx) => (
